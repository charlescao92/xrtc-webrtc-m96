...
class AbsoluteSendTime {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kAbsSendTimeUri;
  }
...
class AbsoluteCaptureTimeExtension {
 public:
  ...
  static constexpr uint8_t kValueSizeBytesWithoutEstimatedCaptureClockOffset =
      8;
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kAbsoluteCaptureTimeUri;
  }
...
class AudioLevel {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kAudioLevelUri;
  }
...
class CsrcAudioLevel {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kCsrcAudioLevelsUri;
  }
...
class TransmissionOffset {
 public:
  ...
  static constexpr uint8_t kValueSizeBytes = 3;
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kTimestampOffsetUri;
  }
...
class TransportSequenceNumberV2 {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kTransportSequenceNumberV2Uri;
  }
...
class VideoOrientation {
 public:
  ...
  static constexpr uint8_t kValueSizeBytes = 1;
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kVideoRotationUri;
  }
...
class PlayoutDelayLimits {
 public:
  ...
  static constexpr uint8_t kValueSizeBytes = 3;
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kPlayoutDelayUri;
  }
...
class VideoContentTypeExtension {
 public:
  ...
  static constexpr uint8_t kValueSizeBytes = 1;
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kVideoContentTypeUri;
  }
...
class VideoTimingExtension {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kVideoTimingUri;
  }
...
class ColorSpaceExtension {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kColorSpaceUri;
  }
...
class RtpStreamId : public BaseRtpStringExtension {
 public:
  ...
  static constexpr absl::string_view Uri() { return webrtc::RtpExtension::kRidUri; }
};
...
class RepairedRtpStreamId : public BaseRtpStringExtension {
 public:
  ...
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kRepairedRidUri;
  }
};
...
class RtpMid : public BaseRtpStringExtension {
 public:
  ...
  static constexpr absl::string_view Uri() { return webrtc::RtpExtension::kMidUri; }
};
...
class VideoFrameTrackingIdExtension {
 public:
  ...
  static constexpr uint8_t kValueSizeBytes = 2;
  static constexpr absl::string_view Uri() {
    return webrtc::RtpExtension::kVideoFrameTrackingIdUri;
  }
